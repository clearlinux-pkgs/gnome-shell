...
Version  : 3.26.1
Release  : 23
URL      : https://download.gnome.org/sources/gnome-shell/3.26/gnome-shell-3.26.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/3.26/gnome-shell-3.26.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1507169646
export AR=gcc-ar
