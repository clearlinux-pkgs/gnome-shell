...
Version  : 47.4
Release  : 199
URL      : https://download.gnome.org/sources/gnome-shell/47/gnome-shell-47.4.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/47/gnome-shell-47.4.tar.xz
...
%prep
%setup -q -n gnome-shell-47.4
cd %{_builddir}/gnome-shell-47.4
pushd ..
cp -a gnome-shell-47.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738783319
...
/usr/lib64/gnome-shell/Shell-15.typelib
/usr/lib64/gnome-shell/St-15.typelib
