...
Source0  : https://download.gnome.org/sources/gnome-shell/3.30/gnome-shell-3.30.1.tar.xz
...
Requires: gnome-shell-config = %{version}-%{release}
...
export LANG=C
export SOURCE_DATE_EPOCH=1539048474
export AR=gcc-ar
