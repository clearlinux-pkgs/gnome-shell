...
Source0  : https://download.gnome.org/sources/gnome-shell/43/gnome-shell-43.3.tar.xz
...
%prep
%setup -q -n gnome-shell-43.3
cd %{_builddir}/gnome-shell-43.3
pushd ..
cp -a gnome-shell-43.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676472563
