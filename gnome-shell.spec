...
Version  : 45.3
Release  : 174
URL      : https://download.gnome.org/sources/gnome-shell/45/gnome-shell-45.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/45/gnome-shell-45.3.tar.xz
...
%prep
%setup -q -n gnome-shell-45.3
cd %{_builddir}/gnome-shell-45.3
pushd ..
cp -a gnome-shell-45.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704732361
