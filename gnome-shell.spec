...
Version  : 44.2
Release  : 161
URL      : https://download.gnome.org/sources/gnome-shell/44/gnome-shell-44.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/44/gnome-shell-44.2.tar.xz
...
%prep
%setup -q -n gnome-shell-44.2
cd %{_builddir}/gnome-shell-44.2
pushd ..
cp -a gnome-shell-44.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685974280
