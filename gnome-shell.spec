...
Version  : 48.1
Release  : 204
URL      : https://download.gnome.org/sources/gnome-shell/48/gnome-shell-48.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/48/gnome-shell-48.1.tar.xz
...
%prep
%setup -q -n gnome-shell-48.1
cd %{_builddir}/gnome-shell-48.1
pushd ..
cp -a gnome-shell-48.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744645922
...
cp %{_builddir}/gnome-shell-%{version}/subprojects/jasmine-gjs/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell/ad17fc83c9eb7a08b41ffa0714253384c1e7f439 || :
cp %{_builddir}/gnome-shell-%{version}/subprojects/jasmine-gjs/debian/copyright %{buildroot}/usr/share/package-licenses/gnome-shell/74601d68fec3a0b01ed69042004c3c21c86c1e0f || :
...
/usr/lib64/gnome-shell/Shell-16.typelib
/usr/lib64/gnome-shell/St-16.typelib
...
/usr/share/dbus-1/interfaces/org.gnome.Shell.ScreenTime.xml
...
/usr/share/desktop-directories/X-GNOME-Shell-System.directory
/usr/share/desktop-directories/X-GNOME-Shell-Utilities.directory
...
/usr/share/gnome-shell/Shell-16.gir
/usr/share/gnome-shell/St-16.gir
...
/usr/share/icons/hicolor/scalable/apps/org.gnome.Shell.CaptivePortal.svg
...
/usr/share/icons/hicolor/symbolic/apps/org.gnome.Shell.CaptivePortal-symbolic.svg
...
/usr/share/package-licenses/gnome-shell/74601d68fec3a0b01ed69042004c3c21c86c1e0f
/usr/share/package-licenses/gnome-shell/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
/usr/share/package-licenses/gnome-shell/ad17fc83c9eb7a08b41ffa0714253384c1e7f439
