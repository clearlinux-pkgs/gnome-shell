...
Version  : 47.3
Release  : 197
URL      : https://download.gnome.org/sources/gnome-shell/47/gnome-shell-47.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/47/gnome-shell-47.3.tar.xz
...
%prep
%setup -q -n gnome-shell-47.3
cd %{_builddir}/gnome-shell-47.3
pushd ..
cp -a gnome-shell-47.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736796662
