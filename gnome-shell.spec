...
Source0  : https://download.gnome.org/sources/gnome-shell/3.36/gnome-shell-3.36.1.tar.xz
...
%prep
%setup -q -n gnome-shell-3.36.1
cd %{_builddir}/gnome-shell-3.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587579636
...
cp %{_builddir}/gnome-shell-3.36.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-shell-3.36.1/data/theme/gnome-shell-sass/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
cp %{_builddir}/gnome-shell-3.36.1/subprojects/extensions-app/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-shell-3.36.1/subprojects/extensions-tool/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell/338650eb7a42dd9bc1f1c6961420f2633b24932d
cp %{_builddir}/gnome-shell-3.36.1/subprojects/shew/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell/01a6b4bf79aca9b556822601186afab86e8c4fbf
