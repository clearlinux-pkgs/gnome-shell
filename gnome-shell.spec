...
Version  : 48.3
Release  : 208
URL      : https://download.gnome.org/sources/gnome-shell/48/gnome-shell-48.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/48/gnome-shell-48.3.tar.xz
...
%prep
%setup -q -n gnome-shell-48.3
cd %{_builddir}/gnome-shell-48.3
pushd ..
cp -a gnome-shell-48.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751312602
