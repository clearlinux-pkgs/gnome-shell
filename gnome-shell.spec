...
Source0  : https://download.gnome.org/sources/gnome-shell/43/gnome-shell-43.1.tar.xz
...
%prep
%setup -q -n gnome-shell-43.1
cd %{_builddir}/gnome-shell-43.1
pushd ..
cp -a gnome-shell-43.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667862947
