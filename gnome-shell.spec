...
Version  : 46.0
Release  : 178
URL      : https://download.gnome.org/sources/gnome-shell/46/gnome-shell-46.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell/46/gnome-shell-46.0.tar.xz
...
%prep
%setup -q -n gnome-shell-46.0
cd %{_builddir}/gnome-shell-46.0
pushd ..
cp -a gnome-shell-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710891325
